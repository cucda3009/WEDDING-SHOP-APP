...
public class ChitiethoadonAdapter extends RecyclerView.Adapter<ChitiethoadonAdapter.ViewHolder> {
    ...
    public ChitiethoadonAdapter(List<ChiTietHoaDon> chiTietDonHangList) {
        this.chiTietHoaDonList = chiTietDonHangList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ChiTietHoaDon chiTiet = chiTietHoaDonList.get(position);
