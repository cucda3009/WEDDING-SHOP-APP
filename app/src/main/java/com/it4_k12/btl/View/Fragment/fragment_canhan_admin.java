...
public class fragment_canhan_admin extends Fragment {
    ...
    private Button btndangxuat,btnqldonhang;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnqldonhang = view.findViewById(R.id.btnqldonhang);
        ...
        btnqldonhang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tạo Intent để chuyển sang Activity mới
                Intent intent = new Intent(getActivity(), DonHangA_admin.class);
                startActivity(intent); // Chuyển sang Activity mới
            }
        });
    ...
    private void updateUI() {
        if (currentUser != null) {
            ...
            txtGioiTinh.setText(currentUser.getGioiTinh());
            txtNgaySinh.setText(currentUser.getNgaySinh());
            txtDiaChi.setText(currentUser.getDiaChi());
            txtNgayTao.setText(currentUser.getNgayTao());
